AFOJ-38 NonRet - Ability to capture Driver Notes
...
Scenario: (01) Validate text box called Driver Notes that allows the user to input data when selecting the Non-Retail radio button
