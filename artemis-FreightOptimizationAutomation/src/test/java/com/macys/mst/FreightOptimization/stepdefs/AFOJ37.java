...
public class AFOJ37 {
    ...
    public void validateafreeformtextboxcalledDriverNotesthatallowstheusertoinputdata() throws Exception {
        FetchExampleTable.sendInputActions(gbldriver, null);
    }

    @Then("verify the maximum text length of characters accepted is 128.")
    public void verifythemaximumtextlengthofcharactersacceptedis() throws Exception {
        FetchExampleTable.sendInputActions(gbldriver, null);
    }

    @Then("verify the maximum text length of characters accepted is 127.")
    public void verifythemaximumtextlengthofcharactersacceptediss() throws Exception {
        FetchExampleTable.sendInputActions(gbldriver, null);
    }

    @Then("close freight movement page")
    public static void closefreightmovementpage() {
        FetchExampleTable.sendInputActions(gbldriver, null);
    }
}
