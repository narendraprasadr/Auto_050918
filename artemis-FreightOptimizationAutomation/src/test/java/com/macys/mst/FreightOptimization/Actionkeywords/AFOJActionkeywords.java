...
public class AFOJActionkeywords {
	...
	/***********************************************************************************************************************************************************
	 * 'Method name : Macysnet_Login 'Project name : FreightOptimizationAutomation
	...
	/***********************************************************************************************************************************************************
	 * 'Method name : verify_LoginUser 'Project name : FreightOptimizationAutomation
	 * 'Description : This method is to verify login Macy's Net Application 'Developer :
	 * Sriram 'Reviewed By : 'Created On : May 2018
	 ************************************************************************************************************************************************************/
	 ...
	 * name:FreightOptimizationAutomation 'Description : This method is to perform
	 * the Verify length of value in test box 'Developer : Sriram 'Reviewed By :
	...
	public static void verify_Text_Length_Should_Be(WebDriver lcldriver, String locString, String numlen) {
...

		{
			...
			if (!actual.isEmpty()) {
				// String message = String.format("Value of text len'%s' should have been '%s'
			...
			// StepDetail.addDetail(String.format("Verify_Text_Length_Should_Be is NOT
	...
	/***********************************************************************************************************************************************************
	 * 'Method name : verify_Dropdownlist_Matches_With_RESTService 'Project name:
	 ...
	 * name:FreightOptimizationAutomation 'Description : This method is to perform
	 * the validation dropdown list with rest services 'Developer : Sriram 'Reviewed
	 * By : 'Created On : June 2018
	 ************************************************************************************************************************************************************/
	...
	/***********************************************************************************************************************************************************
	 * 'Method name : validate_date_Time_values 'Project name : FreightOptimizationAutomation
	 * 'Description : This method is to verify data and time is present in UI 'Developer :
	 * Chenna 'Reviewed By : 'Created On : May 2018
	 ************************************************************************************************************************************************************/
	...
	/***********************************************************************************************************************************************************
	 * 'Method name : Switch_Window 'Project name : FreightOptimizationAutomation
	 * 'Description : This method is to switch to window in UI 'Developer :
	 * praveen 'Reviewed By : 'Created On : May 2018
	 ************************************************************************************************************************************************************/
		...
		/***********************************************************************************************************************************************************
		 * 'Method name : Verify_Value_inDatabase 'Project name : FreightOptimizationAutomation
		 * 'Description : This method is to vaildate value in UI and database 'Developer :
		 * sriram 'Reviewed By : 'Created On : May 2018
		 ************************************************************************************************************************************************************/
	 ...
	 * 'Description : This method is to select date in UI and database 'Developer :
	 * praveen 'Reviewed By : 'Created On : May 2018
	 ************************************************************************************************************************************************************/
	...
	/***********************************************************************************************************************************************************
	 * 'Method name : validateServicePostResponseCode 'Project name : FreightOptimizationAutomation
	 * 'Description : This method is to validate post respone of API Rest 'Developer :
	 * sriram 'Reviewed By : 'Created On : May 2018
	 ************************************************************************************************************************************************************/
