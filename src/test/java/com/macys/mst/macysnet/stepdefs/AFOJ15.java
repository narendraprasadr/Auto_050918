...
public class AFOJ15 {
    ...
    @Given("a new link called Request Freight Movement should be displayed above Document Library on MacysNet Home Page")
    ...
    @Given("a new link called Request Freight Movement should not be displayed above Document Library on MacysNet Home Page")
